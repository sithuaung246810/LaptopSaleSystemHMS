			...
			public SecurityFilterChain securityFilterChain2(HttpSecurity http) throws Exception{
				return http
						.authorizeHttpRequests(authorize -> authorize 
							...
							.requestMatchers("/payment","/admin/**","/login","/logout","/profile","/register","/home","/purchase/**","/cart","/laptop/**","/forgotPassword/**","/resetPassword/**","/profile","/confirmPurchaseCart","/confirmPurchase/**","/removeFromCart","/purchasecart","/purchase/cart","/cart/**","/cartitem/**","/purchase/**","page/**").permitAll()
